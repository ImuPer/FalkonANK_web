 ...
 */
final class Version20260518082234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE music ADD album_id INT DEFAULT NULL, DROP album');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE music ADD album VARCHAR(255) DEFAULT NULL, DROP album_id');
    }
}
